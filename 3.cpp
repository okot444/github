...
namespace linkedlist
{
    ...
    position list::search_pred(position p) const// поиск позиции
    ...
    {
        position q = search_pred(p); // существует ли позиция
        
        if (q == NULL){ // позиции нет
    ...
    position list::  Deletex (position p)  // void изменение позиции
    {
       ...
       /* position q=head;
        ...
        {
        	cout<<"temp NULL"<<endl;
        	return p; // позиции нет - возвращается та же позиция
        }
        /*position temp = head;
...
namespace doublelinkedlist
{
    ...
    int list::search(position p) const// поиск позиции
    // возвращает позицию предыдущего
    //возвращает NULL, если позиции нет
    {
        position q=begin;
   ...
   // возращает объект по позиции в списке
    {
        int q = search(p); // существует ли позиция
        if (q==0){ // позиции нет
            return a.o; // возвращаем фиктивный объект
        }
        return p->o;
